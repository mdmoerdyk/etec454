...
#define CLOCK_LAYER 4
#define DBUTTON_LAYER 3
#define CHANGE_CLOCK 2
...
extern void LcdMoveCursor(INT8U row, INT8U col);
extern void LcdCursor(INT8U on, INT8U blink);
extern void LcdBSpace(void);

extern void LcdShowLayer(INT8U layer);
extern void LcdHideLayer(INT8U layer);