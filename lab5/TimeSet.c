...
void SetTheTime(void)
{
    ...
    TimeGet(&changetime);
    LcdDispTime(1,9,CHANGE_CLOCK,changetime.hr,changetime.min,changetime.sec);
        ...
        switch(curstate)
        {
            ...
            case(TENHRPLACE):
                ...
                if(keypress == '1')
                {
                    ...
                    {
                        LcdDispChar(1,9,CHANGE_CLOCK,'1');
                        hrtenval = 0x0A;
                        tenhrset = TRUE;
                        hourset = TRUE;
                        onepressed = TRUE;
                ...
                else
                {
                    ...
                    {
                        LcdDispChar(1,9,CHANGE_CLOCK,'0');
                        hrtenval = 0x00;
                        tenhrset = TRUE;
                        hourset = TRUE;
                        zeropressed = TRUE; 
            ...
            case(ONEHRPLACE):
                ...
                if(keypress == '0')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'0');
                        hroneval = 0x00;
                        onehrset = TRUE;
                ...
                {
                    LcdDispChar(1,10,CHANGE_CLOCK,'1');
                    hroneval = 0x01;
                    onehrset = TRUE;
                    curstate = TENMINPLACE;
                }
                ...
                {
                    LcdDispChar(1,10,CHANGE_CLOCK,'2');
                    hroneval = 0x02;
                    onehrset = TRUE;
                    curstate = TENMINPLACE;
                }
                else if (keypress == '3')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'3');
                        hroneval = 0x03;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
                ...
                else if (keypress == '4')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'4');
                        hroneval = 0x04;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
                ...
                else if (keypress == '5')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'5');
                        hroneval = 0x05;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
                ...
                else if (keypress == '6')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'6');
                        hroneval = 0x06;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
                ...
                else if (keypress == '7')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'7');
                        hroneval = 0x07;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
                ...
                else if (keypress == '8')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'8');
                        hroneval = 0x08;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
                ...
                else if (keypress == '9')
                {
                    ...
                    {
                        LcdDispChar(1,10,CHANGE_CLOCK,'9');
                        hroneval = 0x09;
                        onehrset = TRUE;
                        curstate = TENMINPLACE;
                    } 
            ...
            case(TENMINPLACE):
                ...
                if(keypress == '0')
                {
                    LcdDispChar(1,12,CHANGE_CLOCK,'0');
                    mintenval = 0x00;
                    tenminset = TRUE;
                ...
                {
                    LcdDispChar(1,12,CHANGE_CLOCK,'1');
                    mintenval = 0x0A;
                    tenminset = TRUE;
                    curstate = ONEMINPLACE;
                }
                ...
                {
                    LcdDispChar(1,12,CHANGE_CLOCK,'2');
                    mintenval = 0x14;
                    tenminset = TRUE;
                    curstate = ONEMINPLACE;
                }
                ...
                {
                    LcdDispChar(1,12,CHANGE_CLOCK,'3');
                    mintenval = 0x1E;
                    tenminset = TRUE;
                    curstate = ONEMINPLACE;
                }
                ...
                {
                    LcdDispChar(1,12,CHANGE_CLOCK,'4');
                    mintenval = 0x28;
                    tenminset = TRUE;
                    curstate = ONEMINPLACE;
                }
                ...
                {
                    LcdDispChar(1,12,CHANGE_CLOCK,'5');
                    mintenval = 0x32;
                    tenminset = TRUE;
                    curstate = ONEMINPLACE;
                }
            ...
            case(ONEMINPLACE):
                ...
                if(keypress == '0')
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'0');
                    minoneval = 0x00;
                    oneminset = TRUE;
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'1');
                    minoneval = 0x01;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'2');
                    minoneval = 0x02;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'3');
                    minoneval = 0x03;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'4');
                    minoneval = 0x04;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'5');
                    minoneval = 0x05;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'6');
                    minoneval = 0x06;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'7');
                    minoneval = 0x07;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'8');
                    minoneval = 0x08;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
                ...
                {
                    LcdDispChar(1,13,CHANGE_CLOCK,'9');
                    minoneval = 0x09;
                    oneminset = TRUE;
                    curstate = TENSECPLACE;
                }
            ...
            case(TENSECPLACE):
                ...
                if(keypress == '0')
                {
                    LcdDispChar(1,15,CHANGE_CLOCK,'0');
                    sectenval = 0x00;
                    tensecset = TRUE;
                ...
                {
                    LcdDispChar(1,15,CHANGE_CLOCK,'1');
                    sectenval = 0x0A;
                    tensecset = TRUE;
                    curstate = ONESECPLACE;
                }
                ...
                {
                    LcdDispChar(1,15,CHANGE_CLOCK,'2');
                    sectenval = 0x14;
                    tensecset = TRUE;
                    curstate = ONESECPLACE;
                }
                ...
                {
                    LcdDispChar(1,15,CHANGE_CLOCK,'3');
                    sectenval = 0x1E;
                    tensecset = TRUE;
                    curstate = ONESECPLACE;
                }
                ...
                {
                    LcdDispChar(1,15,CHANGE_CLOCK,'4');
                    sectenval = 0x28;
                    tensecset = TRUE;
                    curstate = ONESECPLACE;
                }
                ...
                {
                    LcdDispChar(1,15,CHANGE_CLOCK,'5');
                    sectenval = 0x32;
                    tensecset = TRUE;
                    curstate = ONESECPLACE;
                }
            ...
            case(ONESECPLACE):
                ...
                if(keypress == '0')
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'0');
                    seconeval = 0x00;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH; 
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'1');
                    seconeval = 0x01;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'2');
                    seconeval = 0x02;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'3');
                    onesecset = TRUE;
                    seconeval = 0x03;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'4');
                    seconeval = 0x04;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'5');
                    seconeval = 0x05;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'6');
                    seconeval = 0x06;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'7');
                    seconeval = 0x07;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'8');
                    seconeval = 0x08;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
                ...
                {
                    LcdDispChar(1,16,CHANGE_CLOCK,'9');
                    seconeval = 0x09;
                    onesecset = TRUE;
                    curstate = VALUEGOESTHROUGH;
                }
